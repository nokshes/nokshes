 ...
 */
const connectLocalhost = (username, password) => {
  try {
    global.sequelize = new Sequelize("nokshesdb", username, password, {
      host: "localhost",
      dialect: "mssql",
      dialectOptions: {
        options: {
...
module.exports = { connect, connectLocalhost, testConnection };
